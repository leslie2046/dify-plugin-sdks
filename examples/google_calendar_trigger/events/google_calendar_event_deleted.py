...
class GoogleCalendarEventDeletedEvent(Event):
    """Emit Google Calendar events that were cancelled or removed."""
    ...
    def _on_event(
        ...
        events = collect_events(payload, "deleted")
        ...
        return build_variables(
            payload=payload, calendar_id=calendar_id, events=enriched
        )
