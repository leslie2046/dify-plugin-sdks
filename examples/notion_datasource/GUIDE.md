...
- [OpenAI](https://github.com/langgenius/dify-plugin-sdks/tree/main/examples/openai): best practice for model provider
- [Google Search](https://github.com/langgenius/dify-plugin-sdks/tree/main/examples/google): a simple example for tool provider
- [Neko](https://github.com/langgenius/dify-plugin-sdks/tree/main/examples/neko): a funny example for endpoint group
