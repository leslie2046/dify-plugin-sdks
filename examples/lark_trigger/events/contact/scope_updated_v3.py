    ...
    def _on_event(
        ...
        if event_data.added:
            added_scope = {
                ...
                "departments": list(event_data.added.departments)
                if event_data.added.departments
                else [],
                "user_groups": list(event_data.added.user_groups)
                if event_data.added.user_groups
                else [],
            }
        ...
        if event_data.removed:
            removed_scope = {
                ...
                "departments": list(event_data.removed.departments)
                if event_data.removed.departments
                else [],
                "user_groups": list(event_data.removed.user_groups)
                if event_data.removed.user_groups
                else [],
            }
