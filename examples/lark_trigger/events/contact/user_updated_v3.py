...
from lark_oapi.api.contact.v3.model.custom_attr_generic_user import (
    CustomAttrGenericUser,
)
...
def _build_user_snapshot(user: UserEvent | None) -> dict[str, Any]:
    ...
    return {
        ...
        "avatar_key": user.avatar.avatar_72
        if user.avatar and user.avatar.avatar_72
        else "",
        "status": status,
...
class ContactUserUpdatedV3Event(Event):
    def _on_event(
        ...
        variables_dict: dict[str, Any] = {
            ...
            "dotted_line_leader_user_ids": current_snapshot.get(
