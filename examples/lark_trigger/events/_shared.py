...
def dispatch_single_event[EventDataT](
    ...
    register_handler: Callable[
        ...
        Callable[[Callable[[EventDataT], None]], EventDispatcherHandlerBuilder],
    ],
) -> EventDataT:
    ...
    verification_token = runtime.subscription.properties.get(
...
def serialize_user_list(
    users: Iterable[SupportsUserIdentity | None],
) -> list[dict[str, str]]:
