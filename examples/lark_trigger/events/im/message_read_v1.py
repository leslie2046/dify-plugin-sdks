...
class MessageReadV1Event(Event):
    def _on_event(
        ...
        if event_data.reader:
            variables_dict["reader_id"] = event_data.reader.reader_id or ""
            variables_dict["read_time"] = event_data.reader.read_time or ""
            variables_dict["tenant_key"] = event_data.reader.tenant_key or ""
