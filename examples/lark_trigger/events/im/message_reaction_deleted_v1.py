...
class MessageReactionDeletedV1Event(Event):
    def _on_event(
        ...
        variables_dict: dict[str, Any] = {
            ...
            "reaction_type": event_data.reaction_type or "",
        }
        ...
        if event_data.user_id:
            variables_dict["user_open_id"] = event_data.user_id.open_id or ""
            variables_dict["user_user_id"] = event_data.user_id.user_id or ""
            variables_dict["user_union_id"] = event_data.user_id.union_id or ""
        else:
