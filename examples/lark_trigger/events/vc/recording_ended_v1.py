...
class VcRecordingEndedV1Event(Event):
    def _on_event(
        self,
        request: Request,
        ...
        """
        Handle video conference recording ended event.

        This event is triggered when recording ends for a video conference meeting.
        """
