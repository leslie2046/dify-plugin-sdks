...
class DiscussionUnifiedEvent(Event):
    """Unified Discussion event.

    Supports created, edited, deleted, answered, labeled, unlabeled, and
    category_changed actions.
    """
    ...
    def _on_event(
        ...
        self._check_title_body(
            discussion,
            parameters.get("title_contains"),
            parameters.get("body_contains"),
        )
