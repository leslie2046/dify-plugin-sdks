    ...
    class Permission(BaseModel):
        ...
        class Model(BaseModel):
            enabled: bool | None = Field(
                default=False, description="Whether to enable invocation of model"
            )
            llm: bool | None = Field(
                default=False, description="Whether to enable invocation of llm"
            )
            text_embedding: bool | None = Field(
                default=False,
                description="Whether to enable invocation of text embedding",
            )
            rerank: bool | None = Field(
                default=False, description="Whether to enable invocation of rerank"
            )
            tts: bool | None = Field(
                default=False, description="Whether to enable invocation of tts"
            )
            ...
            moderation: bool | None = Field(
                default=False, description="Whether to enable invocation of moderation"
            )
        ...
        class Node(BaseModel):
            enabled: bool | None = Field(
                default=False, description="Whether to enable invocation of node"
            )
        ...
        class Endpoint(BaseModel):
            enabled: bool | None = Field(
                default=False, description="Whether to enable registration of endpoint"
            )
        ...
        class App(BaseModel):
            enabled: bool | None = Field(
                default=False, description="Whether to enable invocation of app"
            )
        ...
        class Storage(BaseModel):
            enabled: bool | None = Field(
                default=False, description="Whether to enable uses of storage"
            )
            size: int = Field(
                ge=1024, le=1073741824, default=1048576, description="Size of storage"
            )
        ...
        endpoint: Endpoint | None = Field(
            default=None, description="Permission of endpoint"
        )
        app: App | None = Field(default=None, description="Permission of app")
        storage: Storage | None = Field(
            default=None, description="Permission of storage"
        )

    permission: Permission | None = Field(
        default=None, description="Permission of plugin"
    )
...
class PluginConfiguration(BaseModel):
    ...
    class Plugins(BaseModel):
        tools: list[str] = Field(
            ...
            description=(
                "manifest paths of tool providers in yaml format, refers to "
        ...
        models: list[str] = Field(
            default_factory=list,
            description=(
                "manifest paths of model providers in yaml format, refers to "
        ...
        endpoints: list[str] = Field(
            default_factory=list,
            description=(
                "manifest paths of endpoint groups in yaml format, refers to "
    ...
    class Meta(BaseModel):
        ...
        version: str = Field(
            ...,
            description=(
                "The version of the manifest specification, designed for "
                "backward compatibility,"
                "when installing an older plugin to a newer Dify, it's hard "
                "to ensure breaking changes never happen,"
                " but at least, Dify can detect it by this field, it knows "
                "which version of the manifest is supported."
            ),
        )
        ...
        minimum_dify_version: str | None = Field(
            None,
            description=(
                "The minimum version of Dify, designed for forward "
                "compatibility."
                "When installing a newer plugin to an older Dify, many new "
                "features may not be available,"
                "but showing the minimum Dify version helps users understand "
                "how to upgrade."
            ),
        )
