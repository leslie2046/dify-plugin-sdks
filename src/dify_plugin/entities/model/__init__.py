...
PARAMETER_RULE_TEMPLATE: dict[DefaultParameterName, dict] = {
    DefaultParameterName.TEMPERATURE: {
        ...
        "type": "float",
        "help": {
            "en_US": "Controls randomness. Lower temperature results in less "
            "random completions. As the temperature approaches zero, the model "
            "will become deterministic and repetitive. Higher temperature "
            "results in more random completions.",
            "zh_Hans": "温度控制随机性。较低的温度会导致较少的随机完成。"
    ...
    DefaultParameterName.TOP_P: {
        ...
        "help": {
            ...
            "zh_Hans": "通过核心采样控制多样性：0.5表示考虑了一半的"
            "所有可能性加权选项。",
        },
        "required": False,
        "default": 1.0,
    ...
    DefaultParameterName.TOP_K: {
        ...
        "type": "int",
        "help": {
            "en_US": "Limits the number of tokens to consider for each step by "
            "keeping only the k most likely tokens.",
    ...
    DefaultParameterName.PRESENCE_PENALTY: {
        ...
        "type": "float",
        "help": {
            "en_US": "Applies a penalty to the log-probability of tokens "
            "already in the text.",
    ...
    DefaultParameterName.FREQUENCY_PENALTY: {
        ...
        "type": "float",
        "help": {
            "en_US": "Applies a penalty to the log-probability of tokens that "
            "appear in the text.",
    ...
    DefaultParameterName.RESPONSE_FORMAT: {
        ...
        "type": "string",
        "help": {
            "en_US": "Set a response format, ensure the output from llm is a "
            "valid code block as possible, "
            "such as JSON, XML, etc.",
            "zh_Hans": "设置一个返回格式，确保llm的输出尽可能是有效的"
            "代码块，如JSON、XML等",
        },
        "required": False,
        "options": ["JSON", "XML"],
...
class ProviderModel(BaseModel):
    ...
    features: list[ModelFeature] | None = Field(
        default=None, description="The features of the model"
    )
    fetch_from: FetchFrom = Field(
        default=FetchFrom.PREDEFINED_MODEL, description="The fetch from"
    )
    model_properties: dict[ModelPropertyKey, Any] = Field(
        ..., description="The model properties"
    )
    deprecated: bool = Field(
        default=False, description="Whether the model is deprecated"
    )
...
class ParameterRule(BaseModel):
    ...
    help: I18nObject | None = Field(
        default=None, description="The help of the parameter"
    )
    required: bool = Field(
    ...
    min: float | None = Field(
        default=None, description="The minimum value of the parameter"
    )
    max: float | None = Field(
        default=None, description="The maximum value of the parameter"
    )
    precision: int | None = Field(
        default=None, description="The precision of the parameter"
    )
